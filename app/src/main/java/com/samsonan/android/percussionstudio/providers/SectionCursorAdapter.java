...
/**
 * It is the SectionCursorAdapter by twotoasters. with minor modifications
 *
...
public abstract class SectionCursorAdapter extends CursorAdapter implements SectionIndexer {
    ...
    ArrayList<Integer> mSectionList = new ArrayList<>();
    ...
    /**
     * @param listPosition element position in the list
